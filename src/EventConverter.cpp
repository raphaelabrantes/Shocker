...
EventConverter::EventConverter(std::unordered_map<std::string, Actions::Action *> &eventEventClassifierMap)
    ...
    _eventsNameMap[EventClassifier(2, 0, -1)] = "L3_MU";
    _eventsNameMap[EventClassifier(2, 0, 3)] = "L3_MD";
    _eventsNameMap[EventClassifier(2, 1, -1)] = "L3_ML";
    _eventsNameMap[EventClassifier(2, 1, 3)] = "L3_MR";
    _eventsNameMap[EventClassifier(2, 2, -1)] = "L2";
    _eventsNameMap[EventClassifier(2, 2, 3)] = "L2";
    _eventsNameMap[EventClassifier(2, 3, -1)] = "R3_MU";
    _eventsNameMap[EventClassifier(2, 3, 3)] = "R3_MD";
    _eventsNameMap[EventClassifier(2, 4, -1)] = "R3_ML";
    _eventsNameMap[EventClassifier(2, 4, 3)] = "R3_MR";
